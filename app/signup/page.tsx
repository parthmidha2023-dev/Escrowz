        ...
        >
          ...
          {success ? (
            ...
            >
              ...
              <h3 style={{ fontSize: 18, fontWeight: 700, color: "#fff" }}>Secure Identity Registered</h3>
              <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", marginTop: 8, lineHeight: 1.6 }}>
                Your decentralized wallet identity keys have been generated and securely cached. Welcome to Escrowz.
              </p>
              ...
              <div style={{
                ...
                IDENTITY_HASH: sha256_e821b0ff456e
              </div>
